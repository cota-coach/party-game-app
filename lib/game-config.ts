...
export const SOUND_PATHS = {
  ...
  explosion: "/sounds/bomb/explosion/explosion.mp3",
  ...
  fake: ["/sounds/bomb/fake/fart.mp3", "/sounds/bomb/fake/dud.mp3", "/sounds/bomb/fake/fanfare.mp3"],
  roulette: { drumroll: "/sounds/bomb/roulette/drumroll.mp3", decision: "/sounds/bomb/roulette/decision.mp3" }
} as const;

export const GAME_AUDIO_SOURCES = [SOUND_PATHS.explosion, ...Object.values(SOUND_PATHS.commands), ...SOUND_PATHS.fake] as const;
