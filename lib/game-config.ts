...
export const COMMAND_DISPLAY_MS = 3500;
export const FAKE_SOUND_INTERVAL = { min: 9, max: 20 };
export const SOUND_PATHS = { ticking:"/sounds/bomb/ticking/ticking.mp3", explosion:"/sounds/bomb/explosion/explosion.mp3", commands:{reverse:"/sounds/bomb/commands/reverse.mp3",skipOne:"/sounds/bomb/commands/skip-one.mp3",skipTwo:"/sounds/bomb/commands/skip-two.mp3",repeatTwo:"/sounds/bomb/commands/repeat-two.mp3",repeatThree:"/sounds/bomb/commands/repeat-three.mp3"}, fake:["/sounds/bomb/fake/fake-1.mp3","/sounds/bomb/fake/fake-2.mp3","/sounds/bomb/fake/fake-3.mp3"] } as const;
