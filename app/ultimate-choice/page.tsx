...
export default function UltimateChoicePage(){
 ...
 const cards=choice&&<div className="choice-stage" key={choice.id}><div className="choice-card a"><small>CHOOSE THIS?</small><span className="choice-letter">A</span><span className="choice-text">{choice.optionA}</span></div><p className="versus">VS</p><div className="choice-card b"><small>OR THIS?</small><span className="choice-letter">B</span><span className="choice-text">{choice.optionB}</span></div></div>;
 return <main className={`shell choice-shell choice-${phase}`}>
  <div className="texture" aria-hidden="true"/><div className="choice-scribble" aria-hidden="true">PICK<br/>ONE!</div>
